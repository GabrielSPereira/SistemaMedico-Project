 ...
 * @author GABRIEL
 */
public class Cadastro_Exame extends javax.swing.JFrame {

    /**
     * Creates new form Cadastro_Exame
     */
    ArrayList<Medico> medicosTela = new ArrayList<>();
    int posPacTela, posMedTela;
    public Cadastro_Exame(ArrayList<Medico> medicos, int posPac, int posMed) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Exame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastro_Exame().setVisible(true);
            }
        });
    }
